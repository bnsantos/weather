package com.bnsantos.weather.ui.recyclerview;
...
public class SwipeDismiss implements View.OnTouchListener {
  ...
  public interface DismissCallbacks {
    ...
    /**
     * Called when the user has indicated they she would toggleLike to dismiss one or more list item
     * positions.
     *
   ...
   * @param callbacks    The callback to trigger when the user has indicated that she would toggleLike to
   *                     dismiss one or more list items.
   */
  public SwipeDismiss(RecyclerView recyclerView, DismissCallbacks callbacks) {
   ...
   * to this listener. This will ensure that this {@link SwipeDismiss} is
